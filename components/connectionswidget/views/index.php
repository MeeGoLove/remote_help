...
<div class="file-manager-container file-manager-col-view">
    ...
    ?>
        ...
        <div class="file-item">
            ...
            <?php
            if ($editing) {
                echo '<div class="file-item-actions btn-group">

                <button type="button" class="btn btn-default btn-sm rounded-pill icon-btn borderless md-btn-flat hide-arrow dropdown-toggle" data-toggle="dropdown" title="Щелкните для редактирования"><i class="ion ion-ios-more"></i></button>
...
<div class="file-item-img-no"></div>
            ...
            if ($editing) {
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="#" onclick="$(\'#updateConnection' . $connection->id . '\').modal();"
                    class="file-item-dropdown-menu glyphicon glyphicon-pencil btn btn-info" title="Изменить"></a>
