...
?>
<div class="file-manager-container file-manager-col-view col-md-5">
    ...
    foreach ($child_units as $child_unit) {
        ...
        <div class="file-item">
            ...
            <a href=<?= Url::to(['tree/index', 'unit_id' => $child_unit->id]) ?> class="file-item-name connection-name">
                <div class="file-item-icon far fa-folder text-secondary"></div>            
                <div  class=""><?= $child_unit->name ?></div>
            </a>            
            ...
            <div class="btn-group">
                ...
                <div class="">
                    ...
                    ModalAjax::widget([
                        ...
                        'toggleButton' => [
                            'label' => '',
                            'class' => 'file-item-dropdown-menu glyphicon glyphicon-pencil btn btn-info'
                        ],
                    ...
                    ?>
                    <!--<button class="file-item-dropdown-menu" href="javascript:void(0)">Переименовать</button>-->
...
<div class="file-item-img" style="background-image: url(' . '/icons-remote/thumb/' . $connection->deviceType->defaultConnectionType->icon . ');"></div>
			...
			<div class="file-item-img" style="background-image: url(' . '/icons-remote/thumb/' . $connection->deviceType->optionalConnectionType->icon . ');"></div>
                ...
                ?>
                <hr class="m-0" />
                <?= '<a class="" href="' . $connection->deviceType->defaultConnectionType->protocol_link . $connection->ipaddr . '">' ?>
                <?= $connection->name ?></a>
            </div>
