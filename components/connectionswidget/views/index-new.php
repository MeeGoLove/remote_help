...
<div class="view-account col-md-7">
            ...
            <div class="content-panel">
                ...
                <div class="drive-wrapper drive-grid-view">
                    <div class="grid-items-wrapper">
                        <?php
                        if ($parent_id !== null) {
                            echo '<div class="drive-item module text-center">
                            <div class="drive-item-inner module-inner">
                                <div class="drive-item-title"><a href=' . Url::to(['tree/index', 'unit_id' => $parent_id]) . '>вверх</a></div>
                                <div class="drive-item-thumb">
                                    <a href=' . Url::to(['tree/index', 'unit_id' => $parent_id]) . '><i class="fa fa-level-up-alt  text-primary"></i></a>
                                </div>
                            </div>
                        ...
                        foreach ($child_units as $child_unit) {
                            ...
                            <div class="drive-item module text-center">
                                <div class="drive-item-inner module-inner">
                                    <div class="drive-item-title"><a href=<?= Url::to(['tree/index', 'unit_id' => $child_unit->id]) ?>><?= $child_unit->name ?></a></div>
                                    <div class="drive-item-thumb">
                                        <a href=<?= Url::to(['tree/index', 'unit_id' => $child_unit->id]) ?>><i class="fa fa-folder text-primary"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="drive-item module text-center">
                                <div class="drive-item-inner module-inner">
                                    ...
                                    <div class="drive-item-thumb">
                                        ...
                                        "\"" . $connection->deviceType->defaultConnectionType->protocol_link .
                                        $connection->ipaddr . "\""
                                        ?>><img class="img-responsive" src=<?= '"/icons-remote/thumb/' . $connection->deviceType->defaultConnectionType->icon . '"' ?> alt=""></a>
                                ...
                                <div class="drive-item-footer module-footer">
                                    <ul class="utilities list-inline">
                                        <li>
                                            <a href="#" onclick=<?= "$('#updateConnection".$connection->id."').modal();"?> class="fa fa-edit"></a>
