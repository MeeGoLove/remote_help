...
<div class="tree-index">
    <div class="row">
        ...
        <div class="col-md-7 col-sm-12  col-12 search-block-admin">
                        ...
                        <div class="btn-group" role="group" data-toggle="buttons">
                            ...
                            if ($view_type == "icons") {
                                echo "                                           
                                        ...
                                        <label class='btn btn-default active' onclick='window.location.href =\"index?unit_id=$unit_id_&admin=1&changeAdmin=1&view_type=grid&change_view=1\"' title='Админ режим'>
